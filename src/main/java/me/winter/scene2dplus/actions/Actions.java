...
import me.winter.scene2dplus.Action;
import me.winter.scene2dplus.Actor;
import me.winter.scene2dplus.EventListener;
...
public class Actions {
	...
	public static SizeToAction sizeTo(float x, float y, int align) {
		return sizeTo(x, y, align, 0f, null);
	}

	public static SizeToAction sizeTo(float x, float y, int align, float duration) {
		return sizeTo(x, y, align, duration, null);
	}

	public static SizeToAction sizeTo(float x, float y, int align, float duration, Interpolation interpolation) {
	...
	/**
	 * Creates an action that runs continually but with a delay between each run
	 *
	 * @param runnable action to run every X seconds
