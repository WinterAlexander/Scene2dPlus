...
import me.winter.scene2dplus.utils.*;

import static me.winter.scene2dplus.actions.Actions.*;
...
public class SelectBox<T> extends Widget implements Disableable {
	...
	/**
	 * @return Max number of items to display when the box is opened, or less than or equal to 0 to display them all.
	 */
	...
	public static class SelectBoxStyle {
		...
		public SelectBoxStyle(SelectBoxStyle style) {
			...
			listStyle = new List.ListStyle(style.listStyle);
